                ...
                <div className={"gigs-feedback-container"}>
                    ...
                    <div className={"info-block"}>
                        <div className={"info-block-booker"}>
                            <Avatar src={avatarurl} size={114} style={{
                                borderRadius: '50%',
                    ...
                    <div className={"emotions-block"}>
                        ...
                        <div className={'pills-picker'}>
                            <span className={this.state.extra === 'Yes' ? 'active' : ''}
                                  onClick={this.handleClick.bind(this, 'extra', 'Yes')}>Yes</span>
                            <span className={this.state.extra === 'No' ? 'active' : ''}
                                  onClick={this.handleClick.bind(this, 'extra', 'No')}>No</span>
                        </div>
                    </div>
