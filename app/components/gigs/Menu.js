            ...
            <Col md={3}>
                ...
                >
                    ...
                    >
                        ...
                        <Divider/>
                    <div  className={`${!this.props.location.pathname.indexOf("/gigs") ? 'selected-list-menu-item' : 'menu-list-item'}`}>
                    ...
                    <div onClick={this.nextPage.bind(this, '/search')} className="menu-list-item">
                        ...
                        <Divider/>
                    <div onClick={this.nextPage.bind(this, '/today/calendar')} className={`${!this.props.location.pathname.indexOf("/today/calendar") ? 'selected-list-menu-item' : 'menu-list-item'}`}>
                        ...
                        <Divider/>
                    <div onClick={this.nextPage.bind(this, '/today/messager')} className={`${!this.props.location.pathname.indexOf("/today/messager") ? 'selected-list-menu-item' : 'menu-list-item'}`}>
                        ...
                        <Divider/>
                    <div onClick={this.nextPage.bind(this, profileLink)} className={`${index === 'fan' || index === 'booker' || index === 'talent' ? 'selected-list-menu-item' : 'menu-list-item'}`}>
                    ...
                    <div onClick={this.nextPage.bind(this, '/today/payment')} className={`${!this.props.location.pathname.indexOf("/today/payment") ? 'selected-list-menu-item' : 'menu-list-item'}`}
                        ...
                        <div style={{marginRight: "1.8rem"}}>
                            <SvgIcon xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 51.3 92.4" style={{enableBackground:"new 0 0 51.3 92.4", width: "1.9rem", height:"1.9rem", position: "relative", top: "0"}}>
                                <g>
                ...
                <div className={'gigs-menu'}>
                    <div onClick={this.nextPage.bind(this,'/gigs/ongoing')}
                         className={(!this.props.location.pathname.indexOf("/gigs/ongoing"))|| ((!this.props.location.pathname.indexOf("/gigs")&& this.props.location.pathname.indexOf("/gigs/")))? "gigs-menu-item-active" :"gigs-menu-item"}>
                        <h5>Ongoing</h5>
                        <span>6</span>
                    </div>
                    <div onClick={this.nextPage.bind(this,'/gigs/booked')}
                         className={!this.props.location.pathname.indexOf("/gigs/booked")?"gigs-menu-item-active":"gigs-menu-item"}>
                        <h5>Booked</h5>
                        <span>1</span>
                    </div>
                    <div onClick={this.nextPage.bind(this,'/gigs/pre-booked')}
                         className={!this.props.location.pathname.indexOf("/gigs/pre-booked")?"gigs-menu-item-active":"gigs-menu-item"}>
                        <h5>Pre-booked</h5>
                        <span>12</span>
                    </div>
                    ...
                    <div onClick={this.nextPage.bind(this,'/gigs/favorites')}
                         className={!this.props.location.pathname.indexOf("/gigs/favorites")?"gigs-menu-item-active":"gigs-menu-item"}>
                        <h5>My favorites</h5>
                        <span>5</span>
                    </div>
                </div>
