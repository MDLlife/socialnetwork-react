  ...
  return(
      <div>
          <TextField
            ...
            inputStyle={{padding: "0 1rem 0 1rem"}}
            hintStyle={{bottom: "5.8rem", padding: "0 1rem 0 1rem", fontSize: "1.4rem", color:"#808080"}}
            name={"message"}
          />
          <Divider/>
          <div className={"chat-input-field-bottom"}>
              <div style={{display: "flex"}}>
                  <SvgIcon style={{transform: "rotate(-90deg)", transformOrigin: "center center", marginTop: "0.7rem"}} viewBox={"0 0 24 24"}>
                      <path fill={"#808080"} d={"M 2 12.5 C 2 9.46 4.46 7 7.5 7 H 18 c 2.21 0 4 1.79 4 4 s -1.79 4 -4 4 H 9.5 C 8.12 15 7 13.88 7 12.5 S 8.12 10 9.5 10 H 17 v 2 H 9.41 c -0.55 0 -0.55 1 0 1 H 18 c 1.1 0 2 -0.9 2 -2 s -0.9 -2 -2 -2 H 7.5 C 5.57 9 4 10.57 4 12.5 S 5.57 16 7.5 16 H 17 v 2 H 7.5 C 4.46 18 2 15.54 2 12.5 Z"}/>
                      <path fill={"none"} d={"M 0 0 h 24 v 24 H 0 V 0 Z"}/>
                  </SvgIcon>
                  <SvgIcon style={{height:"2rem", width:"2rem", marginTop: "1rem"}} viewBox="0 0 438.533 438.533">
                  ...
                  <p onClick={props.handler}>Offer gig</p>
              </div>
              <div className={"chat-input-field-submit"}>Submit</div>
          </div>
      </div>
  )
};
