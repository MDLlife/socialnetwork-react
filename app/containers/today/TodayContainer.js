                        ...
                        >
                            ...
                            <li className={`${!this.props.location.pathname.indexOf("/today/payment") ? 'selected-menu-item-today' : 'menu-item'}`}
                                ...
                                <div style={{marginRight: "1.8rem"}}>
                                    <SvgIcon xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 51.3 92.4" style={{enableBackground:"new 0 0 51.3 92.4", width: "1.9rem", height:"1.9rem", position: "relative", top: "1rem"}}>
                                        <g>
